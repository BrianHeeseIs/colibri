...
echo "waiting for baseline (warmup48) to finish..."
while pgrep -f warmup48.sh >/dev/null; do sleep 10; done
./notify.sh "Baseline experiment complete"
sleep 5
...
sleep 5
./notify.sh "All three experiments complete. Ready for review"
